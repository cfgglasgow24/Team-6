...
//             {showPreview && (
//                 <iframe src="/assets/cv-template.pdf" style={{ width: '100%', height: '500px', marginTop: '20px' }}></iframe>
//             )}

//             <button onClick={handlePreviewClick} style={{ display: 'block', marginTop: '20px' }}>Show Preview</button>
//         </div>
//     );
// };
